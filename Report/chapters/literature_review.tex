...
The intended role is screening and experiment prioritization, not replacement of qualification tests or combustion physics. Only ignition and FSR are modeled. Extinction, flame length, HRR, and smoke/aerosol prediction remain future modeling tasks. This boundary preserves a clear distinction between the database's definition of flammability and the narrower scope of the validated machine-learning evidence. The project predicts recorded ignition and FSR outcomes; it does not certify flight materials or solve the full reacting-flow problem. A reliable material-selection tool must make clear both what has been learned from existing tests and where a new experiment remains the only defensible next step.
